...
_VELOCITY = _descriptor.Descriptor(
  name='Velocity',
  full_name='state_msgs.Velocity',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='x', full_name='state_msgs.Velocity.x', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='y', full_name='state_msgs.Velocity.y', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='z', full_name='state_msgs.Velocity.z', index=2,
...
Velocity = _reflection.GeneratedProtocolMessageType('Velocity', (_message.Message,), dict(
  ...
  __module__ = 'Velocity_pb2'
  # @@protoc_insertion_point(class_scope:state_msgs.Velocity)
  ))
