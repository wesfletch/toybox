...
_QUATERNION = _descriptor.Descriptor(
  name='Quaternion',
  full_name='primitive_msgs.Quaternion',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='x', full_name='primitive_msgs.Quaternion.x', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='y', full_name='primitive_msgs.Quaternion.y', index=1,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='z', full_name='primitive_msgs.Quaternion.z', index=2,
      ...
      serialized_options=None, file=DESCRIPTOR),
    _descriptor.FieldDescriptor(
      name='w', full_name='primitive_msgs.Quaternion.w', index=3,
...
Quaternion = _reflection.GeneratedProtocolMessageType('Quaternion', (_message.Message,), dict(
  ...
  # @@protoc_insertion_point(class_scope:primitive_msgs.Quaternion)
  ))
