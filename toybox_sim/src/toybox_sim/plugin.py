...
if TYPE_CHECKING:
    from entity import Entity, HasPlugins
...
class ImuPlugin(Plugin):
    ...
    plugin_name: str = "ImuPlugin"
    plugin_type: PLUGIN_TYPE = PLUGIN_TYPE.INTEROCEPTIVE
...
class DiffDrivePlugin(Plugin):
    ...
    def parse_config(
        ...
        if "use_vel_target_timeout" in json_dict:
            self._use_target_timeout = bool(json_dict["use_vel_target_timeout"])
